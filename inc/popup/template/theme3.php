<?php ob_start();?>
		   ...
		   <!-- The Modal -->
           <div id="contentoptin_myModal" style="display: none; position: fixed; z-index: 999; left: 0;top: 0;bottom:0;right:0; overflow-x:hidden; overflow-y:auto; padding-top:50px;background-color: rgb(0,0,0); background-color: rgba(0,0,0,0.9); ">
